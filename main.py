...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(360, 302)
        MainWindow.setMinimumSize(QtCore.QSize(360, 302))
        MainWindow.setMaximumSize(QtCore.QSize(360, 302))
    ...
    def Save(self):
        ...
        path = Path(name)
        output_dir = Path().resolve() / 'Audio Files'
